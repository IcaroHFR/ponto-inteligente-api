package com.pi.pontointeligente.api.controllers;
...
import com.pi.pontointeligente.api.dtos.CadastroPJDto;
...
public class CadastroPJController {
	...
	private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
		...
		this.funcionarioService.buscarPorCpf(cadastroPJDto.getCpf())
				.ifPresent(emp -> result.addError(new ObjectError("cpf", "CPF já existente.")));
	
		this.funcionarioService.buscarPorEmail(cadastroPJDto.getEmail())
				.ifPresent(emp -> result.addError(new ObjectError("email", "Email já existente.")));
	}
	 ...
	 * @param result
	 * @return Funcionario
	 * @throws NoSuchAlgoruithmException
	 */
